...
from controllers.database_helpers import connect_to_database  # noqa: E501
from controllers.database_helpers import close_conection_to_database  # noqa: E501
...
def get_all_meetings():
    try:
        ...
        sql_query = "SELECT name FROM Meetings;"
